...
$("#example").on('click', 'tr #editar', function () {
    var idTask = $(this).parents("tr").find("td").eq(0).html();
    var url = "/OperationsTaks/Edit?id=" + idTask + ""; // Establecer URL de la acción
...
$("#agregar").click(function () {
    var url = "/OperationsTaks/Create"; // Establecer URL de la acción
...
function LoadGrid() {
    $('#example').dataTable({
        ...
        bProcessing: true,
        sAjaxSource: '/OperationsTaks/get',
        "columns": [
          { "data": "TaskID" },
          { "data": "Titulo" },
          { "data": "Status" },
