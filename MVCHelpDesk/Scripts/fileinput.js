...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                // SE COMENTA LAS PRIMERAS 3 LINEAS
                fileActionSettings: {
                    showRemove: true,
                    showUpload: true,
                    showZoom: false,
    ...
    $.fn.fileinput.defaults = {
        ...
        uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',//debe quedar vacio
    ...
    $.fn.fileinputLocales.en = {
        ...
        uploadLabel: 'Upload',//DEBE QUEDAR VACIO
        uploadTitle: 'Uploaddfff',//DEBE QUEDAR VACIO
        msgNo: 'No',
        ...
        //SE CAMBIA EL TITULO
        msgFilesTooMany: 'El numero de archivos seleccionados es <b>({n})</b> y se ha excedido el limite que es <b>{m}.</b>.Por favor elimine los archivos y vuelva a subirlos',
        ...
        //SE CAMBIA EL TITULO
        msgInvalidFileExtension: 'Formato del archivo invalida "{name}". Los siguientes formatos son los permitidos "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
